...
mediaType:1,
mediaUrl: 'https://www.instagram.com/adit.hdaa',
sourceUrl: "https://www.instagram.com/adit.hdaa"}}}, { quoted: m })
}
try {
...
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
    ...
    if ( checkuangUser(sender) <= yaya) return reply(`saldo mu kurang cok`)
  if (args[0] === '1'){
